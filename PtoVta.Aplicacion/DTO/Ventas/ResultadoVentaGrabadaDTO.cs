...
{
    public class ResultadoVentaGrabadaDTO
    {
        ...
        // public List<ResultadoAgregaVentaDetalleDTO> VentaDetalles { get; set; }
        // public List<ResultadoAgregaVentaConTarjetaDTO> VentaConTarjetas { get; set; }
        // public List<ResultadoAgregaVentaConValeDTO> VentaConVales { get; set; }
    }
}